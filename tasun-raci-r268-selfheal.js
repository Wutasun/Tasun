/*
  Tasun RACI R268 統一修補模組
  適用檔案：捷運汐東線權責分工精簡版.html
  目的：把本次需求納入 Tasun v5 + TasunSelfHealV5 檢查基準。
...
(function(){
  ...
  function repairStatusBar(){
    ...
    var actual = Math.max(localRows.length, cloudRows.filter(function(r){ return r && !r.deleted && !r._deleted; }).length);
