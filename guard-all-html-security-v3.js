// guard-all-html-security-v3.js
// One-click script: inject Tasun Security v3 guards into all HTML pages except index.html
// Run: node guard-all-html-security-v3.js
//
// Injects into <head> (no UI/CSS changes):
//  1) Inline guard (sync) checking sessionStorage token -> redirect to index.html?next=...
//  2) <script src="tasun-auth-v3.js"></script>
//  3) <script src="tasun-cloudwrap-v3.js"></script>
//  4) <script src="tasun-guard-v3.js"></script>
...
const SESSION_KEY = "tasunAuthSession_v3";
...
function scripts(){
  return `  <script src="tasun-auth-v3.js"></script>
  <script src="tasun-cloudwrap-v3.js"></script>
  <script src="tasun-guard-v3.js"></script>
`;
}

function hasAlready(html){
  const lower = html.toLowerCase();
  return lower.includes("tasun-auth-v3.js") && lower.includes("tasun-guard-v3.js") && html.includes(SESSION_KEY);
}
...
for (const f of targets) {
  ...
  if (r.changed) {
    ...
    changed++;
    console.log("✔ guarded security v3:", f);
  } else if (r.warn) {
